...
class HookedTransformerConfig:
    ...
    Args:
        ...
        use_split_qkv_normalized_input (bool): whether to explicitly calculate
            the layer-normalized-input to each head and QKV input separately
    ...
    use_split_qkv_normalized_input: bool = False
