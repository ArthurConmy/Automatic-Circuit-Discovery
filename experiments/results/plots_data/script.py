...
used = set()
commands = ['make acdc-greaterthan-kl_div-False-0.json', 'make sp-greaterthan-kl_div-False-0.json', 'make acdc-greaterthan-kl_div-True-0.json', 'make acdc-ioi-kl_div-False-0.json']
