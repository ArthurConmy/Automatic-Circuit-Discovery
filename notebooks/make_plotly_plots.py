...
for metric_idx in [1, 0]:
    for ablation_type in ["random_ablation", "zero_ablation"]:
        for weights_type in ["trained", "reset"]:  # Didn't scramble the weights enough it seems
            for plot_type in ["roc_edges_neurips_reviewers", "kl_edges_induction", "metric_edges", "roc_nodes_neurips_reviewers", "roc_edges", "metric_edges_induction", "metric_edges_4", "kl_edges_4", "kl_edges", "precision_recall", "roc_nodes"]:
