...
class ExperimentMetric:
    def __init__(
        self,
        metric: Callable[[Any, Any], torch.Tensor],
        dataset: Any,
        scalar_metric=True,
...
class ExperimentConfig:
    ...
    def adapt_to_model(self, model: Any):
...
class AblationConfig(ExperimentConfig):
    def __init__(
        ...
        abl_fn: Callable[[torch.tensor, torch.tensor, Any], torch.tensor] = None,
        **kwargs,
    ):
...
class PatchingConfig(ExperimentConfig):
    ...
    def __init__(
        ...
        patch_fn: Callable[
            [torch.tensor, torch.tensor, Any], torch.tensor
        ] = None,
        cache_act: bool = True,
        **kwargs,
    ):
...
class EasyExperiment:
    ...
    def __init__(
        self, model: Any, config: ExperimentConfig, metric: ExperimentMetric
    ):
        self.model = model
        self.metric = metric
...
class EasyPatching(EasyExperiment):
    def __init__(
        self, model: Any, config: PatchingConfig, metric: ExperimentMetric
    ):
        super().__init__(model, config, metric)
