...
if IPython.get_ipython() is not None: # heheh get around this failing in notebooks
    ...
    args = parser.parse_args("--task tracr-reverse --using-wandb --threshold 0.005 --zero-ablation --wandb-project-name acdc --indices-mode reverse --first-cache-cpu False --second-cache-cpu False".split())
else:
